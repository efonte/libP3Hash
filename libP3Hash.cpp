...
std::vector<uint32_t> decryptBlock(std::vector<uint32_t> block)
{
    ...
    t6 = hashTable[(0x801 + (((_a1_0x0 / 0x100) & 0xFF) * 0x4)) / 4] ^ (hashTable[(0x1 + (((_a1_0x0 / 0x1000000) & 0xFF) * 0x4)) / 4] ^ hashTable[(0x401 + (((_a1_0x0 / 0x10000) & 0xFF) * 0x4)) / 4]);
    t5 = hashTable[(0xC01 + ((_a1_0x0 & 0xFF) * 0x4)) / 4] ^ t6;
    ...
    t6 = hashTable[(0x801 + (((_a1_0x8 / 0x100) & 0xFF) * 0x4)) / 4] ^ hashTable[(0x1 + (((_a1_0x8 / 0x1000000) & 0xFF) * 0x4)) / 4] ^ hashTable[(0x401 + (((_a1_0x8 / 0x10000) & 0xFF) * 0x4)) / 4];
    t5 = hashTable[(0xC01 + ((_a1_0x8 & 0xFF) * 0x4)) / 4] ^ t6;
    ...
    t6 = _a1_0x0;
    t1 = hashTable[((0xC01 + (((_a1_0x4 / 0x100) & 0xFF) * 0x4))) / 4] ^ (hashTable[(0x801 + (((_a1_0x4 / 0x10000) & 0xFF) * 0x4)) / 4] ^ (hashTable[(0x1 + ((_a1_0x4 & 0xFF) * 0x4)) / 4] ^ hashTable[(0x401 + (((_a1_0x4 / 0x1000000) & 0xFF) * 0x4)) / 4]));
    t5 = hashTable[(0x1 + (((t6 / 0x1000000) & 0xFF) * 0x4)) / 4] ^ hashTable[(0x401 + (((t6 / 0x10000) & 0xFF) * 0x4)) / 4];
    t5 = hashTable[(0xC01 + ((t6 & 0xFF) * 0x4)) / 4] ^ (hashTable[(0x801 + (((t6 / 0x100) & 0xFF) * 0x4)) / 4] ^ t5);
    ...
    t6 = hashTable[(0x801 + (((_a1_0x0 / 0x100) & 0xFF) * 0x4)) / 4] ^ t5;
    t5 = hashTable[(0xC01 + ((_a1_0x0 & 0xFF) * 0x4)) / 4] ^ t6;
    ...
    t0 = (hashTable[(0xC01 + ((_a1_0x8 & 0xFF) * 0x4)) / 4] ^ (hashTable[(0x801 + (((_a1_0x8 / 0x100) & 0xFF) * 0x4)) / 4] ^ (hashTable[(0x1 + (((_a1_0x8 / 0x1000000) & 0xFF) * 0x4)) / 4] ^ hashTable[(0x401 + (((_a1_0x8 / 0x10000) & 0xFF) * 0x4)) / 4]))) ^ magicTable[0x4];
    a0 = _a1_0x4 ^ (((t0 / 0x100) + (t0 * 0x1000000)) ^ ((t1 ^ magicTable[0x5]) ^ t0));
    v1 = _a1_0x8 ^ magicTable[0x0];
