...
std::vector<uint32_t> decryptBlock(std::vector<uint32_t> block)
{
    ...
    t2 = t2 ^ t3;
    t1 = t1 ^ t2;
    t2 = 0x8A6A2BC + (((t6 >> 0x18) & ((1 << 0x8) - 1)) << 0x2);
    uint32_t t5 = hashTable[(t2 - 0x8A6A2BB) / 4];
    t2 = 0x8A6A6BC + (((t6 >> 0x10) & ((1 << 0x8) - 1)) << 0x2);
    ...
    t1 = _a1_0xC;
    t4 = t1 ^ t2;
    t1 = 0x8A6A2BC + ((t4 & 0xFF) << 0x2);
    t3 = hashTable[(t1 - 0x8A6A2BB) / 4];
    _a1_0xC = t4;
    t6 = _a1_0x8;
    t1 = 0x8A6A6BC + (((t4 >> 0x18) & ((1 << 0x8) - 1)) << 0x2);
    ...
    t5 = _a1_0x4;
    t6 = _a1_0x0;
    t1 = 0x8A6A2BC + ((t5 & 0xFF) << 0x2);
    t3 = hashTable[(t1 - 0x8A6A2BB) / 4];
    t1 = 0x8A6A6BC + (((t5 >> 0x18) & ((1 << 0x8) - 1)) << 0x2);
    t2 = hashTable[(t1 - 0x8A6A2BB) / 4];
    ...
    t1 = 0x8A6AABC + t1;
    t2 = hashTable[(t1 - 0x8A6A2BB) / 4];
    t1 = 0x8A6AEBC + (((t4 >> 0x8) & ((1 << 0x8) - 1)) << 0x2);
    t3 = t2 ^ t3;
