...
std::vector<uint32_t> decryptBlock(std::vector<uint32_t> block)
{
    ...
    t1 = hashTable[((0xC01 + (((_a1_0x4 >> 0x8) & 0xFF) << 0x2))) / 4] ^ (hashTable[(0x801 + (((_a1_0x4 >> 0x10) & 0xFF) << 0x2)) / 4] ^ ((hashTable[(0x1 + ((_a1_0x4 & 0xFF) << 0x2)) / 4]) ^ hashTable[(0x401 + (((_a1_0x4 >> 0x18) & 0xFF) << 0x2)) / 4]));
    t6 = hashTable[(0x801 + (((_a1_0x0 >> 0x8) & 0xFF) << 0x2)) / 4] ^ (hashTable[(0x1 + (((_a1_0x0 >> 0x18) & 0xFF) << 0x2)) / 4] ^ hashTable[(0x401 + (((_a1_0x0 >> 0x10) & 0xFF) << 0x2)) / 4]);
    t5 = hashTable[(0xC01 + ((_a1_0x0 & 0xFF) << 0x2)) / 4] ^ t6;

    t4 = t5 ^ magicTable[0x3E];
    t1 = t1 ^ magicTable[0x3F];

    _a1_0x8 = _a1_0x8 ^ (t1 ^ t4);
    _a1_0xC = _a1_0xC ^ (((t4 >> 0x8) + (t4 << 0x18)) ^ (t1 ^ t4));
    t1 = hashTable[((0xC01 + (((_a1_0xC >> 0x8) & 0xFF) << 0x2))) / 4] ^ (hashTable[(0x801 + (((_a1_0xC >> 0x10) & 0xFF) << 0x2)) / 4] ^ (hashTable[(0x1 + ((_a1_0xC & 0xFF) << 0x2)) / 4] ^ hashTable[(0x401 + (((_a1_0xC >> 0x18) & 0xFF) << 0x2)) / 4]));
    t6 = hashTable[(0x801 + (((_a1_0x8 >> 0x8) & 0xFF) << 0x2)) / 4] ^ hashTable[(0x1 + (((_a1_0x8 >> 0x18) & 0xFF) << 0x2)) / 4] ^ hashTable[(0x401 + (((_a1_0x8 >> 0x10) & 0xFF) << 0x2)) / 4];
    t5 = hashTable[(0xC01 + ((_a1_0x8 & 0xFF) << 0x2)) / 4] ^ t6;

    t4 = t5 ^ magicTable[0x3C];
    t1 = t1 ^ magicTable[0x3D];

    _a1_0x0 = _a1_0x0 ^ (t1 ^ t4);
    _a1_0x4 = _a1_0x4 ^ (((t4 >> 0x8) + (t4 << 0x18)) ^ (t1 ^ t4));
    t6 = _a1_0x0;
    t1 = hashTable[((0xC01 + (((_a1_0x4 >> 0x8) & 0xFF) << 0x2))) / 4] ^ (hashTable[(0x801 + (((_a1_0x4 >> 0x10) & 0xFF) << 0x2)) / 4] ^ (hashTable[(0x1 + ((_a1_0x4 & 0xFF) << 0x2)) / 4] ^ hashTable[(0x401 + (((_a1_0x4 >> 0x18) & 0xFF) << 0x2)) / 4]));
    t5 = hashTable[(0x1 + (((t6 >> 0x18) & 0xFF) << 0x2)) / 4] ^ hashTable[(0x401 + (((t6 >> 0x10) & 0xFF) << 0x2)) / 4];
    t5 = hashTable[(0xC01 + ((t6 & 0xFF) << 0x2)) / 4] ^ (hashTable[(0x801 + (((t6 >> 0x8) & 0xFF) << 0x2)) / 4] ^ t5);
    ...
    _a1_0x4 = (_a1_0x4 ^ (((t4 >> 0x8) + (t4 << 0x18)) ^ (t1 ^ t4))) ^ (((magicTable[0x32] & (_a1_0x0 ^ (t1 ^ t4))) << 0x1) + ((magicTable[0x32] & (_a1_0x0 ^ (t1 ^ t4))) >> 0x1F));
    _a1_0x0 = _a1_0x0 ^ (t1 ^ t4) ^ (magicTable[0x33] | _a1_0x4);
    _a1_0x8 = _a1_0x8 ^ (magicTable[0x31] | _a1_0xC);
    _a1_0xC = _a1_0xC ^ (((magicTable[0x30] & _a1_0x8) << 0x1) + ((magicTable[0x30] & _a1_0x8) >> 0x1F));
    t1 = hashTable[(0xC01 + (((_a1_0x4 >> 0x8) & 0xFF) << 0x2)) / 4] ^ hashTable[(0x801 + (((_a1_0x4 >> 0x10) & 0xFF) << 0x2)) / 4] ^ hashTable[(0x1 + ((_a1_0x4 & 0xFF) << 0x2)) / 4] ^ hashTable[(0x401 + (((_a1_0x4 >> 0x18) & 0xFF) << 0x2)) / 4];
    t6 = hashTable[(0x801 + (((_a1_0x0 >> 0x8) & 0xFF) << 0x2)) / 4] ^ hashTable[(0x1 + (((_a1_0x0 >> 0x18) & 0xFF) << 0x2)) / 4] ^ hashTable[(0x401 + (((_a1_0x0 >> 0x10) & 0xFF) << 0x2)) / 4];
    t5 = hashTable[(0xC01 + ((_a1_0x0 & 0xFF) << 0x2)) / 4] ^ t6;
    ...
    _a1_0x4 = (_a1_0x4 ^ (((t4 >> 0x8) + (t4 << 0x18)) ^ (t1 ^ t4))) ^ (((magicTable[0x22] & (_a1_0x0 ^ (t1 ^ t4))) << 0x1) + ((magicTable[0x22] & (_a1_0x0 ^ (t1 ^ t4))) >> 0x1F));
    _a1_0x0 = (_a1_0x0 ^ (t1 ^ t4)) ^ (magicTable[0x23] | _a1_0x4);
    _a1_0x8 = _a1_0x8 ^ (magicTable[0x21] | _a1_0xC);
    _a1_0xC = _a1_0xC ^ (((magicTable[0x20] & _a1_0x8) << 0x1) + ((magicTable[0x20] & _a1_0x8) >> 0x1F));
    t5 = hashTable[(0x801 + (((_a1_0x4 >> 0x10) & 0xFF) << 0x2)) / 4] ^ hashTable[(0x1 + ((_a1_0x4 & 0xFF) << 0x2)) / 4] ^ hashTable[(0x401 + (((_a1_0x4 >> 0x18) & 0xFF) << 0x2)) / 4];
    t1 = hashTable[(0xC01 + (((_a1_0x4 >> 0x8) & 0xFF) << 0x2)) / 4] ^ t5;
    t5 = hashTable[(0x1 + (((_a1_0x0 >> 0x18) & 0xFF) << 0x2)) / 4] ^ hashTable[(0x401 + (((_a1_0x0 >> 0x10) & 0xFF) << 0x2)) / 4];
    t6 = hashTable[(0x801 + (((_a1_0x0 >> 0x8) & 0xFF) << 0x2)) / 4] ^ t5;
    t5 = hashTable[(0xC01 + ((_a1_0x0 & 0xFF) << 0x2)) / 4] ^ t6;
    ...
    _a1_0x4 = (_a1_0x4 ^ (((t4 >> 0x8) + (t4 << 0x18)) ^ (t1 ^ t4))) ^ (((magicTable[0x12] & (_a1_0x0 ^ (t1 ^ t4))) << 0x1) + ((_a1_0x0 ^ (t1 ^ t4)) >> 0x1F));
    _a1_0x0 = (_a1_0x0 ^ (t1 ^ t4)) ^ (magicTable[0x13] | _a1_0x4);
    _a1_0x8 = _a1_0x8 ^ (magicTable[0x11] | _a1_0xC);
    _a1_0xC = _a1_0xC ^ (((magicTable[0x10] & _a1_0x8) << 0x1) + ((magicTable[0x10] & _a1_0x8) >> 0x1F));
    t6 = hashTable[(0x801 + (((_a1_0x0 >> 0x8) & 0xFF) << 0x2)) / 4] ^ hashTable[(0x1 + (((_a1_0x0 >> 0x18) & 0xFF) << 0x2)) / 4] ^ hashTable[(0x401 + (((_a1_0x0 >> 0x10) & 0xFF) << 0x2)) / 4];
    t5 = hashTable[(0xC01 + ((_a1_0x0 & 0xFF) << 0x2)) / 4] ^ t6;
    t4 = t5 ^ magicTable[0xE];
    t1 = hashTable[(0xC01 + (((_a1_0x4 >> 0x8) & 0xFF) << 0x2)) / 4] ^ hashTable[(0x801 + (((_a1_0x4 >> 0x10) & 0xFF) << 0x2)) / 4] ^ (hashTable[(0x1 + ((_a1_0x4 & 0xFF) << 0x2)) / 4] ^ hashTable[(0x401 + (((_a1_0x4 >> 0x18) & 0xFF) << 0x2)) / 4]) ^ magicTable[0xF];
    ...
    t4 = _a1_0xC ^ (((t4 >> 0x8) + (t4 << 0x18)) ^ (t3 ^ t4));
    t1 = hashTable[(0xC01 + (((t4 >> 0x8) & 0xFF) << 0x2)) / 4] ^ (hashTable[(0x801 + (((t4 >> 0x10) & 0xFF) << 0x2)) / 4] ^ (hashTable[(0x1 + ((t4 & 0xFF) << 0x2)) / 4] ^ hashTable[(0x401 + (((t4 >> 0x18) & 0xFF) << 0x2)) / 4]));
    t0 = (hashTable[(0xC01 + ((_a1_0x8 & 0xFF) << 0x2)) / 4] ^ (hashTable[(0x801 + (((_a1_0x8 >> 0x8) & 0xFF) << 0x2)) / 4] ^ (hashTable[(0x1 + (((_a1_0x8 >> 0x18) & 0xFF) << 0x2)) / 4] ^ hashTable[(0x401 + (((_a1_0x8 >> 0x10) & 0xFF) << 0x2)) / 4]))) ^ magicTable[0x4];
    a0 = _a1_0x4 ^ (((t0 >> 0x8) + (t0 << 0x18)) ^ ((t1 ^ magicTable[0x5]) ^ t0));
