...
std::vector<uint32_t> decryptBlock(std::vector<uint32_t> block)
{
    ...
    t4 = _a1_0x4 ^ magicTable[0x41];
    _a1_0x4 = t4;
    t2 = hashTable[(0x401 + (((t4 >> 0x18) & ((1 << 0x8) - 1)) << 0x2)) / 4];
    t1 = ((t4 >> 0x10) & ((1 << 0x8) - 1)) << 0x2;
    t3 = (hashTable[(0x1 + ((t4 & 0xFF) << 0x2)) / 4]) ^ t2;
    t2 = hashTable[(0x801 + t1) / 4];
    t1 = hashTable[((0xC01 + (((t4 >> 0x8) & ((1 << 0x8) - 1)) << 0x2))) / 4];
    t2 = t2 ^ t3;
    t1 = t1 ^ t2;
    t5 = hashTable[(0x1 + (((_a1_0x0 >> 0x18) & ((1 << 0x8) - 1)) << 0x2)) / 4];
    t3 = hashTable[(0x401 + (((_a1_0x0 >> 0x10) & ((1 << 0x8) - 1)) << 0x2)) / 4];
    t2 = ((_a1_0x0 >> 0x8) & ((1 << 0x8) - 1)) << 0x2;
    t5 = t5 ^ t3;
    t3 = hashTable[(0x801 + t2) / 4];
    t2 = (_a1_0x0 & 0xFF) << 0x2;
    t6 = t3 ^ t5;
    ...
    t2 = (t2 << 0x1) + (t2 >> 0x1F);
    _a1_0xC = t1 ^ t2;
    t3 = hashTable[(0x1 + ((_a1_0x4 & 0xFF) << 0x2)) / 4];
    t2 = hashTable[(0x401 + (((_a1_0x4 >> 0x18) & ((1 << 0x8) - 1)) << 0x2)) / 4];
    t1 = ((_a1_0x4 >> 0x10) & ((1 << 0x8) - 1)) << 0x2;
    t3 = t3 ^ t2;
    t2 = hashTable[(0x801 + t1) / 4];
    t1 = ((_a1_0x4 >> 0x8) & ((1 << 0x8) - 1)) << 0x2;
    t5 = t2 ^ t3;
    t3 = hashTable[(0xC01 + t1) / 4];
    t2 = ((_a1_0x0 >> 0x18) & ((1 << 0x8) - 1)) << 0x2;
    t1 = t3 ^ t5;
    t5 = hashTable[(0x1 + t2) / 4] ^ hashTable[(0x401 + (((_a1_0x0 >> 0x10) & ((1 << 0x8) - 1)) << 0x2)) / 4];
    t3 = hashTable[(0x801 + (((_a1_0x0 >> 0x8) & ((1 << 0x8) - 1)) << 0x2)) / 4];
    t2 = (_a1_0x0 & 0xFF) << 0x2;
    t6 = t3 ^ t5;
    t5 = hashTable[(0xC01 + t2) / 4] ^ t6;
    t2 = _a1_0x8;
    ...
    _a1_0x0 = _a1_0x0 ^ t2;
    t2 = magicTable[0x21] | _a1_0xC;
    t3 = _a1_0x8 ^ t2;
    _a1_0x8 = t3;
    t1 = _a1_0xC;
    t2 = magicTable[0x20] & t3;
    t1 = t1 ^ ((t2 << 0x1) + (t2 >> 0x1F));
    _a1_0xC = t1;
    t3 = hashTable[(0x1 + ((_a1_0x4 & 0xFF) << 0x2)) / 4];
    t2 = hashTable[(0x401 + (((_a1_0x4 >> 0x18) & ((1 << 0x8) - 1)) << 0x2)) / 4];
    t1 = ((_a1_0x4 >> 0x10) & ((1 << 0x8) - 1)) << 0x2;
    ...
    t1 = _a1_0x0 ^ t2;
    _a1_0x0 = t1;
    t3 = _a1_0x8 ^ (magicTable[0x11] | _a1_0xC);
    _a1_0x8 = t3;
    ...
    t3 = (t1 ^ magicTable[0x7]);
    t3 = t3 ^ t4;
    _a1_0x8 = t2 ^ t3;
    t4 = _a1_0xC ^ (((t4 >> 0x8) + (t4 << 0x18)) ^ t3);
    t3 = hashTable[(0x1 + ((t4 & 0xFF) << 0x2)) / 4];
    _a1_0xC = t4;
    t2 = hashTable[(0x401 + (((t4 >> 0x18) & ((1 << 0x8) - 1)) << 0x2)) / 4];
    t3 = hashTable[(0x801 + (((t4 >> 0x10) & ((1 << 0x8) - 1)) << 0x2)) / 4] ^ (t3 ^ t2);
    t1 = hashTable[(0xC01 + (((t4 >> 0x8) & ((1 << 0x8) - 1)) << 0x2)) / 4] ^ t3;
    t3 = ((_a1_0x8 >> 0x18) & ((1 << 0x8) - 1)) << 0x2;
    t0 = hashTable[(0x401 + (((_a1_0x8 >> 0x10) & ((1 << 0x8) - 1)) << 0x2)) / 4];
    a3 = hashTable[(0x801 + (((_a1_0x8 >> 0x8) & ((1 << 0x8) - 1)) << 0x2)) / 4];
    t0 = (hashTable[(0xC01 + ((_a1_0x8 & 0xFF) << 0x2)) / 4] ^ (a3 ^ (hashTable[(0x1 + t3) / 4] ^ t0))) ^ magicTable[0x4];
