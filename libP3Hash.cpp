...
std::vector<uint32_t> decryptBlock(std::vector<uint32_t> block)
{
    ...
    uint32_t t5 = hashTable[(0xC01 + ((_a1_0x0 & 0xFF) * 0x4)) / 4] ^ (hashTable[(0x801 + (((_a1_0x0 / 0x100) & 0xFF) * 0x4)) / 4] ^ (hashTable[(0x1 + (((_a1_0x0 / 0x1000000) & 0xFF) * 0x4)) / 4] ^ hashTable[(0x401 + (((_a1_0x0 / 0x10000) & 0xFF) * 0x4)) / 4]));

    uint32_t t4 = t5 ^ magicTable[0x3E];
    t1 = t1 ^ magicTable[0x3F];

    _a1_0x8 = _a1_0x8 ^ (t1 ^ t4);
    _a1_0xC = _a1_0xC ^ (((t4 / 0x100) + (t4 * 0x1000000)) ^ (t1 ^ t4));
    t1 = hashTable[((0xC01 + (((_a1_0xC / 0x100) & 0xFF) * 0x4))) / 4] ^ (hashTable[(0x801 + (((_a1_0xC / 0x10000) & 0xFF) * 0x4)) / 4] ^ (hashTable[(0x1 + ((_a1_0xC & 0xFF) * 0x4)) / 4] ^ hashTable[(0x401 + (((_a1_0xC / 0x1000000) & 0xFF) * 0x4)) / 4]));
    t5 = hashTable[(0xC01 + ((_a1_0x8 & 0xFF) * 0x4)) / 4] ^ (hashTable[(0x801 + (((_a1_0x8 / 0x100) & 0xFF) * 0x4)) / 4] ^ hashTable[(0x1 + (((_a1_0x8 / 0x1000000) & 0xFF) * 0x4)) / 4] ^ hashTable[(0x401 + (((_a1_0x8 / 0x10000) & 0xFF) * 0x4)) / 4]);
    ...
    t5 = hashTable[(0xC01 + ((_a1_0x0 & 0xFF) * 0x4)) / 4] ^ (hashTable[(0x801 + (((_a1_0x0 / 0x100) & 0xFF) * 0x4)) / 4] ^ hashTable[(0x1 + (((_a1_0x0 / 0x1000000) & 0xFF) * 0x4)) / 4] ^ hashTable[(0x401 + (((_a1_0x0 / 0x10000) & 0xFF) * 0x4)) / 4]);
    ...
    t5 = hashTable[(0x801 + (((_a1_0x4 / 0x10000) & 0xFF) * 0x4)) / 4] ^ hashTable[(0x1 + ((_a1_0x4 & 0xFF) * 0x4)) / 4] ^ hashTable[(0x401 + (((_a1_0x4 / 0x1000000) & 0xFF) * 0x4)) / 4];
    t1 = hashTable[(0xC01 + (((_a1_0x4 / 0x100) & 0xFF) * 0x4)) / 4] ^ t5;
    t5 = hashTable[(0x1 + (((_a1_0x0 / 0x1000000) & 0xFF) * 0x4)) / 4] ^ hashTable[(0x401 + (((_a1_0x0 / 0x10000) & 0xFF) * 0x4)) / 4];
    t5 = hashTable[(0xC01 + ((_a1_0x0 & 0xFF) * 0x4)) / 4] ^ (hashTable[(0x801 + (((_a1_0x0 / 0x100) & 0xFF) * 0x4)) / 4] ^ t5);
    ...
    uint32_t t3 = (t1 ^ magicTable[0x7]);

    _a1_0x8 = _a1_0x8 ^ (t3 ^ t4);
    t4 = _a1_0xC ^ (((t4 / 0x100) + (t4 * 0x1000000)) ^ (t3 ^ t4));
    ...
    uint32_t a0 = _a1_0x4 ^ (((t0 / 0x100) + (t0 * 0x1000000)) ^ ((t1 ^ magicTable[0x5]) ^ t0));
