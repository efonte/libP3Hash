...
{
    _a1_0x0 = t2 ^ (t1 ^ t4);
    t4 = _a1_0x4 ^ (((t4 >> 0x8) + (t4 << 0x18)) ^ (t1 ^ t4));
    _a1_0x4 = t4;
    t6 = _a1_0x0;
    ...
    t2 = (t6 & 0xFF) << 0x2;
    t6 = hashTable[(0x801 + (((t6 >> 0x8) & 0xFF) << 0x2)) / 4] ^ t5;
    t5 = hashTable[(0xC01 + t2) / 4] ^ t6;
    t2 = _a1_0x8;
}
...
{
    _a1_0x8 = t2 ^ (t1 ^ t4);
    t4 = _a1_0xC ^ (((t4 >> 0x8) + (t4 << 0x18)) ^ (t1 ^ t4));
    _a1_0xC = t4;
    t1 = hashTable[((0xC01 + (((t4 >> 0x8) & 0xFF) << 0x2))) / 4] ^ (hashTable[(0x801 + (((t4 >> 0x10) & 0xFF) << 0x2)) / 4] ^ (hashTable[(0x1 + ((t4 & 0xFF) << 0x2)) / 4] ^ hashTable[(0x401 + (((t4 >> 0x18) & 0xFF) << 0x2)) / 4]));
...
std::vector<uint32_t> decryptBlock(std::vector<uint32_t> block)
{
    ...
    _a1_0x0 = t2 ^ (t1 ^ t4);
    t2 = ((t4 >> 0x8) + (t4 << 0x18)) ^ (t1 ^ t4);
    _a1_0x4 = (_a1_0x4 ^ t2) ^ (((magicTable[0x32] & _a1_0x0) << 0x1) + ((magicTable[0x32] & _a1_0x0) >> 0x1F));
    _a1_0x0 = _a1_0x0 ^ (magicTable[0x33] | _a1_0x4);
    ...
    _a1_0x0 = t2 ^ (t1 ^ t4);
    _a1_0x4 = (_a1_0x4 ^ (((t4 >> 0x8) + (t4 << 0x18)) ^ (t1 ^ t4))) ^ (((magicTable[0x22] & (_a1_0x0)) << 0x1) + ((magicTable[0x22] & (_a1_0x0)) >> 0x1F));
    _a1_0x0 = _a1_0x0 ^ (magicTable[0x23] | _a1_0x4);
    _a1_0x8 = _a1_0x8 ^ (magicTable[0x21] | _a1_0xC);
    t2 = magicTable[0x20] & _a1_0x8;
    _a1_0xC = _a1_0xC ^ ((t2 << 0x1) + (t2 >> 0x1F));
    ...
    _a1_0x4 = (_a1_0x4 ^ (((t4 >> 0x8) + (t4 << 0x18)) ^ (t1 ^ t4))) ^ (((magicTable[0x12] & (t2 ^ (t1 ^ t4))) << 0x1) + ((t2 ^ (t1 ^ t4)) >> 0x1F));
    _a1_0x0 = (t2 ^ (t1 ^ t4)) ^ (magicTable[0x13] | _a1_0x4);
