...
std::vector<uint32_t> decryptBlock(std::vector<uint32_t> block)
{
    ...
    _a1_0x0 = _a1_0x0 ^ magicTable[0x40];
    uint32_t t4 = _a1_0x4 ^ magicTable[0x41];
    uint32_t t3 = hashTable[(0x1 + ((t4 & 0xFF) << 0x2)) / 4];
    _a1_0x4 = t4;
    uint32_t t2 = hashTable[(0x401 + (((t4 >> 0x18) & ((1 << 0x8) - 1)) << 0x2)) / 4];
    uint32_t t1 = ((t4 >> 0x10) & ((1 << 0x8) - 1)) << 0x2;
    t3 = t3 ^ t2;
    t2 = hashTable[(0x801 + t1) / 4];
    uint32_t t6 = _a1_0x0;
    t1 = hashTable[((0xC01 + (((t4 >> 0x8) & ((1 << 0x8) - 1)) << 0x2))) / 4];
    t2 = t2 ^ t3;
    t1 = t1 ^ t2;
    uint32_t t5 = hashTable[(0x1 + (((t6 >> 0x18) & ((1 << 0x8) - 1)) << 0x2)) / 4];
    t3 = hashTable[(0x8A6A6BC + (((t6 >> 0x10) & ((1 << 0x8) - 1)) << 0x2) - 0x8A6A2BB) / 4];
    ...
    t5 = t5 ^ t6;
    t2 = _a1_0x8;
    t4 = t5 ^ magicTable[0x3E];
    t1 = t1 ^ magicTable[0x3F];
    t3 = t1 ^ t4;
    t1 = t2 ^ t3;
    _a1_0x8 = t1;
    t2 = t4 >> 0x8;
    ...
    t1 = _a1_0xC;
    t4 = t1 ^ t2;
    t3 = hashTable[(0x8A6A2BC + ((t4 & 0xFF) << 0x2) - 0x8A6A2BB) / 4];
    _a1_0xC = t4;
    t6 = _a1_0x8;
    t2 = hashTable[(0x8A6A6BC + (((t4 >> 0x18) & ((1 << 0x8) - 1)) << 0x2) - 0x8A6A2BB) / 4];
    t1 = ((t4 >> 0x10) & ((1 << 0x8) - 1)) << 0x2;
    t3 = t3 ^ t2;
    t2 = hashTable[(0x8A6AABC + t1 - 0x8A6A2BB) / 4];
    t1 = hashTable[((0x8A6AEBC + (((t4 >> 0x8) & ((1 << 0x8) - 1)) << 0x2)) - 0x8A6A2BB) / 4];
    t2 = t2 ^ t3;
    t1 = t1 ^ t2;
    t5 = hashTable[(0x8A6A2BC + (((t6 >> 0x18) & ((1 << 0x8) - 1)) << 0x2) - 0x8A6A2BB) / 4];
    t3 = hashTable[(0x8A6A6BC + (((t6 >> 0x10) & ((1 << 0x8) - 1)) << 0x2) - 0x8A6A2BB) / 4];
    t2 = ((t6 >> 0x8) & ((1 << 0x8) - 1)) << 0x2;
    t5 = t5 ^ t3;
    t3 = hashTable[(0x801 + t2) / 4];
    ...
    t5 = t5 ^ t6;
    t2 = _a1_0x0;
    t4 = t5 ^ magicTable[0x3C];
    t1 = t1 ^ magicTable[0x3D];
    t3 = t1 ^ t4;
    t1 = t2 ^ t3;
    _a1_0x0 = t1;
    t2 = t4 >> 0x8;
    ...
    t5 = t5 ^ t6;
    t2 = _a1_0x8;
    t4 = t5 ^ magicTable[0x3A];
    t1 = t1 ^ magicTable[0x3B];
    t3 = t1 ^ t4;
    t1 = t2 ^ t3;
    _a1_0x8 = t1;
    t2 = t4 >> 0x8;
    ...
    t2 = ((t6 >> 0x8) & ((1 << 0x8) - 1)) << 0x2;
    t5 = t5 ^ t3;
    t3 = hashTable[(0x8A6AABC + t2 - 0x8A6A2BB) / 4];
    t2 = (t6 & 0xFF) << 0x2;
    t6 = t3 ^ t5;
    t5 = hashTable[(0x8A6AEBC + t2 - 0x8A6A2BB) / 4];
    t5 = t5 ^ t6;
    t2 = _a1_0x0;
    t4 = t5 ^ magicTable[0x38];
    t1 = t1 ^ magicTable[0x39];
    t3 = t1 ^ t4;
    t1 = t2 ^ t3;
    _a1_0x0 = t1;
    t2 = t4 >> 0x8;
    ...
    t5 = t5 ^ t6;
    t2 = _a1_0x8;
    t4 = t5 ^ magicTable[0x36];
    t1 = t1 ^ magicTable[0x37];
    t3 = t1 ^ t4;
    t1 = t2 ^ t3;
    _a1_0x8 = t1;
    t2 = t4 >> 0x8;
    ...
    t5 = t5 ^ t6;
    t2 = _a1_0x0;
    t4 = t5 ^ magicTable[0x34];
    t1 = t1 ^ magicTable[0x35];
    t3 = t1 ^ t4;
    t1 = t2 ^ t3;
    _a1_0x0 = t1;
    t2 = t4 >> 0x8;
    ...
    t3 = t1 ^ t2;
    _a1_0x4 = t3;
    t1 = magicTable[0x32] & (_a1_0x0);
    t2 = t1 << 0x1;
    t1 = t2 + (t1 >> 0x1F);
    t3 = t3 ^ t1;
    _a1_0x4 = t3;
    t1 = _a1_0x0;
    t2 = magicTable[0x33] | t3;
    t1 = t1 ^ t2;
    _a1_0x0 = t1;
    t2 = _a1_0xC;
    t1 = _a1_0x8;
    t2 = magicTable[0x31] | t2;
    t3 = t1 ^ t2;
    _a1_0x8 = t3;
    t1 = _a1_0xC;
    t2 = magicTable[0x30] & t3;
    t3 = t2 << 0x1;
    t2 = t3 + (t2 >> 0x1F);
    t1 = t1 ^ t2;
    _a1_0xC = t1;
    ...
    t2 = hashTable[(0x8A6A6BC + (((t5 >> 0x18) & ((1 << 0x8) - 1)) << 0x2) - 0x8A6A2BB) / 4];
    t1 = ((t5 >> 0x10) & ((1 << 0x8) - 1)) << 0x2;
    t3 = t3 ^ t2;
    t2 = hashTable[(0x8A6AABC + t1 - 0x8A6A2BB) / 4];
    t1 = ((t5 >> 0x8) & ((1 << 0x8) - 1)) << 0x2;
    t5 = t2 ^ t3;
    t3 = hashTable[(0xC01 + t1) / 4];
    t1 = (t6 >> 0x18) & ((1 << 0x8) - 1);
    t2 = t1 << 0x2;
    t1 = t3 ^ t5;
    t5 = hashTable[(0x8A6A2BC + t2 - 0x8A6A2BB) / 4];
    t3 = hashTable[(0x8A6A6BC + (((t6 >> 0x10) & ((1 << 0x8) - 1)) << 0x2) - 0x8A6A2BB) / 4];
    t2 = ((t6 >> 0x8) & ((1 << 0x8) - 1)) << 0x2;
    t5 = t5 ^ t3;
    t3 = hashTable[(0x801 + t2) / 4];
    ...
    t5 = t5 ^ t6;
    t2 = _a1_0x8;
    t4 = t5 ^ magicTable[0x2E];
    t1 = t1 ^ magicTable[0x2F];
    t3 = t1 ^ t4;
    t1 = t2 ^ t3;
    _a1_0x8 = t1;
    t2 = t4 >> 0x8;
    ...
    t5 = t5 ^ t6;
    t2 = _a1_0x0;
    t4 = t5 ^ magicTable[0x2C];
    t1 = t1 ^ magicTable[0x2D];
    t3 = t1 ^ t4;
    t1 = t2 ^ t3;
    _a1_0x0 = t1;
    t2 = t4 >> 0x8;
    ...
    t5 = t5 ^ t6;
    t2 = _a1_0x8;
    t4 = t5 ^ magicTable[0x2A];
    t1 = t1 ^ magicTable[0x2B];
    t3 = t1 ^ t4;
    t1 = t2 ^ t3;
    _a1_0x8 = t1;
    t2 = t4 >> 0x8;
    ...
    t5 = t5 ^ t6;
    t2 = _a1_0x0;
    t4 = t5 ^ magicTable[0x28];
    t1 = t1 ^ magicTable[0x29];
    t3 = t1 ^ t4;
    t1 = t2 ^ t3;
    _a1_0x0 = t1;
    t2 = t4 >> 0x8;
    ...
    t5 = t5 ^ t6;
    t2 = _a1_0x8;
    t4 = t5 ^ magicTable[0x26];
    t1 = t1 ^ magicTable[0x27];
    t3 = t1 ^ t4;
    t1 = t2 ^ t3;
    _a1_0x8 = t1;
    t2 = t4 >> 0x8;
    ...
    t5 = t5 ^ t6;
    t2 = _a1_0x0;
    t4 = t5 ^ magicTable[0x24];
    t1 = t1 ^ magicTable[0x25];
    t3 = t1 ^ t4;
    t1 = t2 ^ t3;
    _a1_0x0 = t1;
    t2 = t4 >> 0x8;
    ...
    t3 = t1 ^ t2;
    _a1_0x4 = t3;
    t1 = magicTable[0x22] & (_a1_0x0);
    t2 = t1 << 0x1;
    t1 = t2 + (t1 >> 0x1F);
    t3 = t3 ^ t1;
    _a1_0x4 = t3;
    t1 = _a1_0x0;
    t2 = magicTable[0x23] | t3;
    t1 = t1 ^ t2;
    _a1_0x0 = t1;
    t2 = _a1_0xC;
    t1 = _a1_0x8;
    t2 = magicTable[0x21] | t2;
    t3 = t1 ^ t2;
    _a1_0x8 = t3;
    t1 = _a1_0xC;
    t2 = magicTable[0x20] & t3;
    t3 = t2 << 0x1;
    t2 = t3 + (t2 >> 0x1F);
    t1 = t1 ^ t2;
    _a1_0xC = t1;
    ...
    t5 = t5 ^ t6;
    t2 = _a1_0x8;
    t4 = t5 ^ magicTable[0x1E];
    t1 = t1 ^ magicTable[0x1F];
    t3 = t1 ^ t4;
    t1 = t2 ^ t3;
    _a1_0x8 = t1;
    t2 = t4 >> 0x8;
    ...
    t5 = t5 ^ t6;
    t2 = _a1_0x0;
    t4 = t5 ^ magicTable[0x1C];
    t1 = t1 ^ magicTable[0x1D];
    t3 = t1 ^ t4;
    t1 = t2 ^ t3;
    _a1_0x0 = t1;
    t2 = t4 >> 0x8;
    ...
    t5 = t5 ^ t6;
    t2 = _a1_0x8;
    t4 = t5 ^ magicTable[0x1A];
    t1 = t1 ^ magicTable[0x1B];
    t3 = t1 ^ t4;
    t1 = t2 ^ t3;
    _a1_0x8 = t1;
    t2 = t4 >> 0x8;
    ...
    t5 = t5 ^ t6;
    t2 = _a1_0x0;
    t4 = t5 ^ magicTable[0x18];
    t1 = t1 ^ magicTable[0x19];
    t3 = t1 ^ t4;
    t1 = t2 ^ t3;
    _a1_0x0 = t1;
    t2 = t4 >> 0x8;
    ...
    t5 = t5 ^ t6;
    t2 = _a1_0x8;
    t4 = t5 ^ magicTable[0x16];
    t1 = t1 ^ magicTable[0x17];
    t3 = t1 ^ t4;
    t1 = t2 ^ t3;
    _a1_0x8 = t1;
    t2 = t4 >> 0x8;
    ...
    t5 = t5 ^ t6;
    t2 = _a1_0x0;
    t4 = t5 ^ magicTable[0x14];
    t1 = t1 ^ magicTable[0x15];
    t3 = t1 ^ t4;
    t1 = t2 ^ t3;
    _a1_0x0 = t1;
    t2 = t4 >> 0x8;
    ...
    t3 = t1 ^ t2;
    _a1_0x4 = t3;
    t1 = magicTable[0x12] & (_a1_0x0);
    t2 = t1 << 0x1;
    t1 = t2 + (t1 >> 0x1F);
    t3 = t3 ^ t1;
    _a1_0x4 = t3;
    t1 = _a1_0x0;
    t2 = magicTable[0x13] | t3;
    t1 = t1 ^ t2;
    _a1_0x0 = t1;
    t2 = _a1_0xC;
    t1 = _a1_0x8;
    t2 = magicTable[0x11] | t2;
    t3 = t1 ^ t2;
    _a1_0x8 = t3;
    t1 = _a1_0xC;
    t2 = magicTable[0x10] & t3;
    t3 = t2 << 0x1;
    t2 = t3 + (t2 >> 0x1F);
    t1 = t1 ^ t2;
    _a1_0xC = t1;
    ...
    t5 = t5 ^ t6;
    t2 = _a1_0x8;
    t4 = t5 ^ magicTable[0xE];
    t1 = t1 ^ magicTable[0xF];
    t3 = t1 ^ t4;
    t1 = t2 ^ t3;
    _a1_0x8 = t1;
    t2 = t4 >> 0x8;
    ...
    t5 = t5 ^ t6;
    t2 = _a1_0x0;
    t4 = t5 ^ magicTable[0xC];
    t1 = t1 ^ magicTable[0xD];
    t3 = t1 ^ t4;
    t1 = t2 ^ t3;
    _a1_0x0 = t1;
    t2 = t4 >> 0x8;
    ...
    t5 = t5 ^ t6;
    t2 = _a1_0x8;
    t4 = t5 ^ magicTable[0xA];
    t1 = t1 ^ magicTable[0xB];
    t3 = t1 ^ t4;
    t1 = t2 ^ t3;
    _a1_0x8 = t1;
    t2 = t4 >> 0x8;
    ...
    t2 = t2 ^ t3;
    t1 = t1 ^ t2;
    t5 = hashTable[(0x1 + (((t6 >> 0x18) & ((1 << 0x8) - 1)) << 0x2)) / 4];
    t3 = hashTable[(0x401 + (((t6 >> 0x10) & ((1 << 0x8) - 1)) << 0x2)) / 4];
    t2 = ((t6 >> 0x8) & ((1 << 0x8) - 1)) << 0x2;
    t5 = t5 ^ t3;
    t3 = hashTable[(0x801 + t2) / 4];
    t2 = (t6 & 0xFF) << 0x2;
    ...
    t5 = t5 ^ t6;
    t2 = _a1_0x0;
    t4 = t5 ^ magicTable[0x8];
    t1 = t1 ^ magicTable[0x9];
    t3 = t1 ^ t4;
    t1 = t2 ^ t3;
    _a1_0x0 = t1;
    t2 = t4 >> 0x8;
    ...
    t5 = t5 ^ t6;
    t2 = _a1_0x8;
    t4 = t5 ^ magicTable[0x6];
    t3 = (t1 ^ magicTable[0x7]) ^ t4;
    t1 = t2 ^ t3;
    _a1_0x8 = t1;
    t2 = t4 >> 0x8;
    t4 = _a1_0xC ^ ((t2 + (t4 << 0x18)) ^ t3);
    t3 = hashTable[(0x8A6A2BC + ((t4 & 0xFF) << 0x2) - 0x8A6A2BB) / 4];
    _a1_0xC = t4;
    t2 = hashTable[(0x8A6A6BC + (((t4 >> 0x18) & ((1 << 0x8) - 1)) << 0x2) - 0x8A6A2BB) / 4];
    t1 = ((t4 >> 0x10) & ((1 << 0x8) - 1)) << 0x2;
    ...
    t1 = hashTable[(0x8A6AEBC + (((t4 >> 0x8) & ((1 << 0x8) - 1)) << 0x2) - 0x8A6A2BB) / 4];
    t1 = t1 ^ t3;
    t3 = ((_a1_0x8 >> 0x18) & ((1 << 0x8) - 1)) << 0x2;
    t3 = hashTable[(0x1 + t3) / 4];
    uint32_t t0 = (_a1_0x8 >> 0x10) & ((1 << 0x8) - 1);
    t0 = hashTable[(0x401 + (t0 << 0x2)) / 4];
    uint32_t a3 = (_a1_0x8 >> 0x8) & ((1 << 0x8) - 1);
    a3 = hashTable[(0x801 + (a3 << 0x2)) / 4];
    a3 = hashTable[(0xC01 + ((_a1_0x8 & 0xFF) << 0x2)) / 4] ^ (a3 ^ (t3 ^ t0));
    t0 = a3 ^ magicTable[0x4];
    a3 = (t1 ^ magicTable[0x5]) ^ t0;
    _a1_0x4 = _a1_0x4 ^ (((t0 >> 0x8) + (t0 << 0x18)) ^ a3);
    uint32_t a0 = _a1_0x4;
    uint32_t v1 = _a1_0x8 ^ magicTable[0x0];
    _a1_0x4 = _a1_0xC ^ magicTable[0x1];
    _a1_0x8 = _a1_0x0 ^ a3;
    _a1_0xC = a0;
    _a1_0x0 = v1;
